Snd9A_Header:
	...
	smpsHeaderSFXChannel cFM4, Snd9A_FM4,	$F5, $05
	smpsHeaderSFXChannel cFM5, Snd9A_FM5,	$00, $00
	smpsHeaderSFXChannel cFM3, Snd9A_FM3,	$00, $00
	smpsHeaderSFXChannel cFM6, Snd9A_FM6,	$00, $00
